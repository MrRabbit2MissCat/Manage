...
class DataFromweb(models.Model):
    ...
    mj          = models.CharField(max_length=50, blank=True, null=True)
    high        = models.CharField(max_length=50, blank=True, null=True)
    crown       = models.CharField(db_column='Crown', max_length=50, blank=True, null=True)  # Field name made lowercase.
    dj          = models.CharField(max_length=50, blank=True, null=True)
